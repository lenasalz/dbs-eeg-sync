from dbs_eeg_sync.cli import main
...
#         synchronized_eeg, synchronized_dbs = synchronize_data(cropped_eeg, cropped_dbs, resample_data=None, save_dir="outputs/plots", sub_id=sub_id, block=block)
...
#             save_synchronized_data(synchronized_eeg, synchronized_dbs, "outputs/outputData", sub_id, block)
